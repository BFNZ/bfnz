...
feature 'Authenticating an admin user' do
  background do
    User.make!(:admin, email: 'user@email.com', password: 'p@55w0rd', password_confirmation: 'p@55w0rd')
  end

  scenario "An unauthenticated user visits an admin page" do
    visit "/admin"
    expect(page).to have_text "Sorry, you don't have access to this page"
